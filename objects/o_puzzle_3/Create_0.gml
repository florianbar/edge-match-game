...
_gridAdd(grid, 0, 1, "tile1");
_gridAdd(grid, 1, 0, "tile2");
_gridAdd(grid, 1, 1, "tile3");
...
tile1[? "sides"] = [[1,4], [1,4], [1,2], [1,2]];

tile2 = ds_map_create();
tile2[? "instanceId"] = noone;
tile2[? "sides"] = [[1,1], [1,1], [1,3], [1,3]];
...
tile4[? "sides"] = [[1,4], [1,4], [1,2], [1,2]];

tile5 = ds_map_create();
tile5[? "instanceId"] = noone;
tile5[? "sides"] = [[1,1], [1,1], [1,3], [1,3]];
